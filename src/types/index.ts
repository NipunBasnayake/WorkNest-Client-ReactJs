...
export type PlatformTenantStatus = "PROVISIONING" | "ACTIVE" | "INACTIVE" | "SUSPENDED" | "ARCHIVED" | "REJECTED";
...
export interface Tenant {
  ...
  adminName?: string;
  databaseName?: string;
  status?: PlatformTenantStatus | Lowercase<PlatformTenantStatus> | string;
  active?: boolean;
