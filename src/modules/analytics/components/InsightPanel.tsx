...
const meta = {
  positive: [CheckCircle2, "#059669"],
  info: [Info, "#2563eb"],
  warning: [AlertTriangle, "#d97706"],
  critical: [ShieldAlert, "#dc2626"],
} as const;
    ...
    <section className="rounded-2xl border p-5" style={{ background: "var(--bg-surface)", borderColor: "var(--border-default)" }}>
      ...
      <div className="space-y-2.5">
        {insights.map((insight) => {
          const [Icon, color] = meta[insight.severity];
          return (
            <div key={insight.id} className="rounded-xl border p-3" style={{ borderColor: `${color}35`, background: `${color}0d` }}>
