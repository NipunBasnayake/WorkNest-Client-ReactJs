...
export default function BiChartCard({ title, subtitle, data, variant, insight, series = [{ key: 'value', label: 'Value', color: '#9332ea' }], drillDown, unit = '', compact = false, showExport = true }: Props) {
